...
def test_should_define_base_exception_when_imported():
    ...
    assert issubclass(DriftBenchmarkError, Exception), (
        "DriftBenchmarkError must inherit from Exception"
    )
...
def test_should_define_detector_registry_errors_when_imported():
    ...
    # Arrange & Act
    try:
        from drift_benchmark.exceptions import DetectorNotFoundError, DuplicateDetectorError, DriftBenchmarkError
    except ImportError as e:
        pytest.fail(f"Failed to import detector registry exceptions: {e}")
    
    # Assert - DetectorNotFoundError
    assert issubclass(DetectorNotFoundError, DriftBenchmarkError), (
        "DetectorNotFoundError must inherit from DriftBenchmarkError"
    )
    ...
    assert issubclass(DuplicateDetectorError, DriftBenchmarkError), (
        "DuplicateDetectorError must inherit from DriftBenchmarkError"
    )
...
def test_should_define_method_registry_errors_when_imported():
    ...
    # Arrange & Act
    try:
        from drift_benchmark.exceptions import MethodNotFoundError, ImplementationNotFoundError, DriftBenchmarkError
    except ImportError as e:
        pytest.fail(f"Failed to import method registry exceptions: {e}")
    
    # Assert - MethodNotFoundError
    assert issubclass(MethodNotFoundError, DriftBenchmarkError), (
        "MethodNotFoundError must inherit from DriftBenchmarkError"
    )
    ...
    assert issubclass(ImplementationNotFoundError, DriftBenchmarkError), (
        "ImplementationNotFoundError must inherit from DriftBenchmarkError"
    )
...
def test_should_define_data_errors_when_imported():
    ...
    assert issubclass(DataLoadingError, DriftBenchmarkError), (
        "DataLoadingError must inherit from DriftBenchmarkError"
    )
    ...
    assert issubclass(DataValidationError, DriftBenchmarkError), (
        "DataValidationError must inherit from DriftBenchmarkError"
    )
...
def test_should_define_configuration_errors_when_imported():
    ...
    # Assert
    assert issubclass(ConfigurationError, DriftBenchmarkError), (
        "ConfigurationError must inherit from DriftBenchmarkError"
    )
...
def test_should_define_benchmark_errors_when_imported():
    ...
    # Assert
    assert issubclass(BenchmarkExecutionError, DriftBenchmarkError), (
        "BenchmarkExecutionError must inherit from DriftBenchmarkError"
    )
...
def test_should_provide_all_exceptions_in_module_when_imported():
    ...
    expected_exceptions = [
        'DriftBenchmarkError',
        'DetectorNotFoundError', 'DuplicateDetectorError',
        'MethodNotFoundError', 'ImplementationNotFoundError',
        'DataLoadingError', 'DataValidationError',
        'ConfigurationError',
...
def test_should_have_proper_exception_hierarchy_when_used():
    ...
    try:
        from drift_benchmark.exceptions import (
            DriftBenchmarkError, DetectorNotFoundError, DuplicateDetectorError,
            MethodNotFoundError, ImplementationNotFoundError,
            DataLoadingError, DataValidationError, ConfigurationError, BenchmarkExecutionError
        )
    except ImportError as e:
    ...
    custom_exceptions = [
        ...
        MethodNotFoundError, ImplementationNotFoundError,
        DataLoadingError, DataValidationError,
        ConfigurationError, BenchmarkExecutionError
    ]
    
    for exception_class in custom_exceptions:
        assert issubclass(exception_class, DriftBenchmarkError), (
            f"{exception_class.__name__} must inherit from DriftBenchmarkError"
        )
        assert issubclass(exception_class, Exception), (
            f"{exception_class.__name__} must ultimately inherit from Exception"
        )
...
def test_should_provide_meaningful_error_messages_when_raised():
    ...
    try:
        from drift_benchmark.exceptions import (
            DetectorNotFoundError, MethodNotFoundError, DataLoadingError, ConfigurationError
        )
    except ImportError as e:
