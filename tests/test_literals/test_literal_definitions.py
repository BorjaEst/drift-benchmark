...
def test_should_define_drift_type_literals_when_imported():
    ...
    assert actual_values == expected_values, (
        f"DriftType literal must have exactly {expected_values}, "
        f"but found {actual_values}"
    )
...
def test_should_define_data_type_literals_when_imported():
    ...
    assert actual_values == expected_values, (
        f"DataType literal must have exactly {expected_values}, "
        f"but found {actual_values}"
    )
...
def test_should_define_data_dimension_literals_when_imported():
    ...
    assert actual_values == expected_values, (
        f"DataDimension literal must have exactly {expected_values}, "
        f"but found {actual_values}"
    )
...
def test_should_define_data_labeling_literals_when_imported():
    ...
    assert actual_values == expected_values, (
        f"DataLabeling literal must have exactly {expected_values}, "
        f"but found {actual_values}"
    )
...
def test_should_define_execution_mode_literals_when_imported():
    ...
    assert actual_values == expected_values, (
        f"ExecutionMode literal must have exactly {expected_values}, "
        f"but found {actual_values}"
    )
...
def test_should_define_method_family_literals_when_imported():
    ...
    assert actual_values == expected_values, (
        f"MethodFamily literal must have exactly {expected_values}, "
        f"but found {actual_values}"
    )
...
def test_should_define_dataset_source_literals_when_imported():
    ...
    assert actual_values == expected_values, (
        f"DatasetSource literal must have exactly {expected_values}, "
        f"but found {actual_values}"
    )
...
def test_should_define_file_format_literals_when_imported():
    ...
    assert actual_values == expected_values, (
        f"FileFormat literal must have exactly {expected_values}, "
        f"but found {actual_values}"
    )
...
def test_should_define_log_level_literals_when_imported():
    ...
    assert actual_values == expected_values, (
        f"LogLevel literal must have exactly {expected_values}, "
        f"but found {actual_values}"
    )
...
def test_should_provide_all_literals_in_module_when_imported():
    ...
    # Arrange
    expected_literals = [
        'DriftType', 'DataType', 'DataDimension', 'DataLabeling',
        'ExecutionMode', 'MethodFamily', 'DatasetSource', 'FileFormat', 'LogLevel'
    ]
