...
This module tests the drift detection methods registry system using functional
testing approach organized in test classes following pytest best practices.

Test Classes Organization:
- TestMethodsLoading: Loading and caching of methods registry
- TestMethodAccess: Individual method and detector retrieval
- TestMethodsListing: Listing and enumeration functionality
- TestExistenceValidation: Checking existence and validation
- TestMethodsFiltering: Filtering methods by various criteria
- TestDetectorsFiltering: Filtering detector implementations
- TestCategoryExtraction: Extracting metadata categories
- TestSummaryStatistics: Summary and statistics functionality
- TestErrorHandling: Error cases and edge conditions
- TestRealDataIntegration: Integration tests with real data
...
@pytest.fixture
def sample_methods_data() -> Dict[str, Any]:
...
@pytest.fixture
def temp_methods_toml(sample_methods_data: Dict[str, Any]):
    ...
    from drift_benchmark.detectors import METHODS_TOML
...
class TestMethodsLoading:
    """Test cases for loading and accessing methods from the registry."""

    def test_load_methods_from_real_file(self):
    ...
    def test_load_methods_caching(self):
    ...
    def test_load_methods_with_temp_file(self, temp_methods_toml, sample_methods_data):
...
class TestMethodAccess:
    """Test cases for accessing individual methods and detectors."""

    def test_get_method_existing(self, temp_methods_toml):
    ...
    def test_get_method_nonexistent(self, temp_methods_toml):
        """Test getting a non-existent method."""
        method = get_method("nonexistent_method")
        assert method is None

    def test_get_detector_existing(self, temp_methods_toml):
    ...
    def test_get_detector_nonexistent_method(self, temp_methods_toml):
        """Test getting detector for non-existent method."""
        detector = get_detector("nonexistent_method", "batch_impl")
        assert detector is None

    def test_get_detector_nonexistent_implementation(self, temp_methods_toml):
...
class TestMethodsListing:
    """Test cases for listing and enumerating methods and detectors."""

    def test_list_all_methods(self, temp_methods_toml):
    ...
    def test_list_all_detectors(self, temp_methods_toml):
    ...
    def test_get_method_ids(self, temp_methods_toml):
    ...
    def test_get_detector_ids(self, temp_methods_toml):
...
class TestExistenceValidation:
    """Test cases for validating existence of methods and detectors."""

    def test_method_exists(self, temp_methods_toml):
    ...
    def test_detector_exists(self, temp_methods_toml):
    ...
    def test_get_method_implementation_count(self, temp_methods_toml):
...
class TestMethodsFiltering:
    """Test cases for filtering methods by various criteria."""

    def test_filter_methods_by_drift_type(self, temp_methods_toml):
    ...
    def test_filter_methods_by_family(self, temp_methods_toml):
    ...
    def test_filter_methods_by_data_dimension(self, temp_methods_toml):
    ...
    def test_filter_methods_by_data_types(self, temp_methods_toml):
    ...
    def test_filter_methods_by_requires_labels(self, temp_methods_toml):
    ...
    def test_filter_methods_by_method_ids(self, temp_methods_toml):
    ...
    def test_filter_methods_combined_filters(self, temp_methods_toml):
    ...
    def test_filter_methods_with_none_values(self, temp_methods_toml):
...
class TestDetectorsFiltering:
    """Test cases for filtering detector implementations."""

    def test_filter_detectors_by_execution_mode(self, temp_methods_toml):
    ...
    def test_filter_detectors_with_method_filters(self, temp_methods_toml):
    ...
    def test_filter_detectors_by_implementation_ids(self, temp_methods_toml):
    ...
    def test_filter_detectors_with_none_values(self, temp_methods_toml):
...
class TestCategoryExtraction:
    """Test cases for extracting available categories and metadata."""

    def test_get_drift_types(self, temp_methods_toml):
    ...
    def test_get_families(self, temp_methods_toml):
    ...
    def test_get_data_dimensions(self, temp_methods_toml):
    ...
    def test_get_data_types(self, temp_methods_toml):
    ...
    def test_get_execution_modes(self, temp_methods_toml):
...
class TestSummaryStatistics:
    """Test cases for summary and statistics functionality."""

    def test_get_summary(self, temp_methods_toml):
...
class TestErrorHandling:
    ...
    def test_invalid_methods_toml(self):
    ...
    def test_missing_methods_toml(self):
...
class TestRealDataIntegration:
    """Test cases using real methods.toml data for integration testing."""

    def test_real_methods_toml_structure(self):
    ...
    def test_real_methods_validation(self):
    ...
    def test_comprehensive_filtering_real_data(self):
